        ...
        <form action="" method="post">
            ...
            <div class="container_nom">
                ...
                <div class="input_password"> 
                    <input onclick="EffectPassword()" type="text" name="nom" id="inputNom" placeholder="Nom" class="form-control" required pattern="^[A-Za-z '-]+$" maxlength="20">
                </div>
            </div>
            ...
            <div class="container_pseudo">
                ...
                <div class="input_mail"> 
                    <input onclick="EffectMail()" type="text" name="pseudo" id="inputPseudo" placeholder="Pseudo" class="form-control" required pattern="^[A-Za-z '-]+$" maxlength="20">
                </div>
            </div>
            <div class="container_mail">
                <div class="ico_"><i class="far fa-envelope"></i></div>
                <div class="input_mail"> 
                    <input onclick="EffectMail()" type="email" name="email" id="inputEmail" placeholder="E-mail" class="form-control" autocomplete="email" required pattern="^[A-Za-z]+@{1}[A-Za-z]+\.{1}[A-Za-z]{2,}$" maxlength="20">
                </div>
            </div>
            ...
            <div class="container_passwordCheck">
                <div class="ico_"><i class="fas fa-lock"></i></div>
                <div class="input_password"> 
                    <input onclick="EffectPassword()" type="password" name="confirm" id="inputPasswordCheck" placeholder="Comfirme le mot de passe" class="form-control" autocomplete="current-password" required>
                </div>
            </div>
